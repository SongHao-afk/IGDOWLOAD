...
class MediaCard extends StatelessWidget {
  ...
  const MediaCard({super.key, required this.item, required this.onDownload});
          ...
          if (!isVideo)
            Image.network(
              ...
              errorBuilder: (_, __, ___) {
                return _fallback(context, Icons.broken_image_rounded);
              },
            )
          else
            _fallback(context, Icons.play_arrow_rounded),
          if (isVideo)
            Container(
